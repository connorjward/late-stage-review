...
\def\drawpolygon#1,#2;{
    \begin{pgfonlayer}{background}
        \filldraw[line width=5,join=round](#1.center)foreach\A in{#2}{--(\A.center)}--cycle;
        \filldraw[line width=4,join=round,white](#1.center)foreach\A in{#2}{--(\A.center)}--cycle;
    \end{pgfonlayer}
}

% my attempt at inner lines
\def\drawpolygon#1,#2;{
    \begin{pgfonlayer}{background}
        \filldraw[line width=4](#1.center)foreach\A in{#2}{--(\A.center)}--cycle;
        \draw[line width=5,white](#1.center)foreach\A in{#2}{--(\A.center)}--cycle;
    \end{pgfonlayer}
}
...
\begin{tikzpicture}
  ...
  \node [xshift=-2cm,yshift=.8cm] (c0c1label) at (c0c1) {$(c_5,c_1)$};
  \draw (c0c1label) -- (c0c1);

  \tkzDefMidPoint(e1v0,c0e2v0) \tkzGetPoint{c0e2}
  \node [xshift=2cm,yshift=.8cm] (c0e2label) at (c0e2) {$(c_5,e_2,e_0)$};
  \draw (c0e2label) -- (c0e2);

  \tkzDefBarycentricPoint(e1v0=1,e1e1v0=1,c0e2v0=1) \tkzGetPoint{c0c3c2}
  \node [xshift=2cm,yshift=-.2cm] (c0c3c2label) at (c0c3c2) {$(c_5,c_3,c_2)$};
...
\begin{tikzpicture}[y=-1cm]
  \begin{scope}[xshift=1.5cm, yshift=0cm]
    ...
    \filldraw[draw=black, fill=white] (1.5,0) node[ptlabel]{$c_5$} rectangle ++ (1,1);
    \draw (0,0) -- (4,0);
    \draw (0,1) -- (4,1);
  \end{scope}

  \begin{scope}[xshift=0cm, yshift=-2cm]
    \filldraw[draw=black, fill=blue!20] (0,0) node[ptlabel]{$c_1$} rectangle ++ (1,1);
    \filldraw[draw=black, fill=white] (1,0) node[ptlabel]{$c_2$} rectangle ++ (1,1);
    \filldraw[draw=black, fill=white] (2,0) node[ptlabel]{$c_3$} rectangle ++ (1,1);
    \filldraw[draw=black, fill=white] (3,0) node[ptlabel]{$c_4$} rectangle ++ (1,1);
    \filldraw[draw=black, fill=white] (4,0) node[ptlabel]{$e_0$} rectangle ++ (1,1);
    \filldraw[draw=black, fill=white] (5,0) node[ptlabel]{$e_1$} rectangle ++ (1,1);
    \filldraw[draw=black, fill=white] (6,0) node[ptlabel]{$e_2$} rectangle ++ (1,1);

    \draw[->] (3.45,-1) .. controls ([yshift=-.7cm] 3.45,-1) and ([yshift=1cm] .5,0) .. (.5,0);
    \draw[->] (3.5,-1) .. controls ([yshift=-.8cm] 3.5,-1) and ([yshift=1cm] 2.5,0) .. (2.5,0);
    \draw[->] (3.55,-1) .. controls ([yshift=-.7cm] 3.55,-1) and ([yshift=1cm] 6.5,0) .. (6.5,0);
  \end{scope}
  ...
  \begin{scope}[xshift=0cm, yshift=-4cm]
    ...
    \begin{scope}[xshift=0cm]
      \fill[lightgray] (0,0) rectangle (4,1);
      \filldraw[draw=black, fill=white] (.5,0) node[ptlabel]{$c_1$} rectangle ++ (1,1);
      \filldraw[draw=black, fill=blue!20] (1.5,0) node[ptlabel]{$c_2$} rectangle ++ (1,1);
      \filldraw[draw=black, fill=white] (2.5,0) node[ptlabel]{$c_3$} rectangle ++ (1,1);
      \draw[->] (2.5,-1) .. controls ([yshift=-.6cm] 2.5,-1) and ([yshift=1cm] 2,0) .. (2,0);
    \end{scope}

    % e2
    \begin{scope}[xshift=4.5cm]
      \filldraw[draw=black, fill=blue!20] (0,0) node[ptlabel]{$e_0$} rectangle ++ (1,1);
      \filldraw[draw=black, fill=white] (1,0) node[ptlabel]{$e_1$} rectangle ++ (1,1);
      \filldraw[draw=black, fill=white] (2,0) node[ptlabel]{$v_0$} rectangle ++ (1,1);
      \draw[->] (2,-1) .. controls ([yshift=-.6cm] 2,-1) and ([yshift=1cm] .5,0) .. (.5,0);
    \end{scope}
  \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}
  ...
  % testing
  \drawpolygon c0e2v0,e1v0,e1e1v0;
